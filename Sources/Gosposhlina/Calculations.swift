        ...
        case .ru01012005_08092024:
            ...
            case .commonUrisdiction:
                ...
                if amount == 0 {
                    ...
                    textLabel = "Любая сумма до 10 000 рублей. \nПри цене иска до 10000 рублей госпошлина равна 400 рублям, поэтому точно указать какая цена иска, если госпошлина равно 400 рублей – нельзя. Это любая сумма до 10000 рублей."
                    
                } else if amount < 400 {
                    textLabel = "Госпошлина не может быть меньше 400 руб."
                
                } else if amount >= 60000 {
                    textLabel = "Любая сумма свыше 10 360 000 руб. \nПри цене иска 10 360 000 рублей госпошлина достигает размера 60000 рублей и далее уже при любой цене иска госпошлина остается 60 000 рублей. Поэтому точно сказать, какая цена иска при госпошлине, равной 60 000 рублей, нельзя. Это любая сумма свыше 10 360 000 рублей."
            ...
            case .arbitrazh:
                ...
                if amount == 0 {
                    ...
                    textLabel = "Любая сумма до 50 000 рублей. \nПри цене иска до 50 000 рублей госпошлина равна 2 000 рублям, поэтому точно указать какая цена иска, если госпошлина равно 2 000 рублей – нельзя. Это любая сумма до 50 000 рублей."
               
                } else if amount < 2000 {
                    textLabel = "Госпошлина не может быть меньше 2000 руб."
                    
                } else if amount >= 200000 {
                    textLabel = "Любая сумма свыше 35 400 000 руб. \nПри цене иска 35 400 000 рублей госпошлина достигает размера 200 000 рублей и далее уже при любой цене иска госпошлина остается 200 000 рублей. Поэтому точно сказать, какая цена иска при госпошлине, равной 200 000 рублей, нельзя. Это любая сумма свыше 35 400 000 рублей."
                      
                    if amount > 200000 {
                        textLabel = "Введенная госпошлина больше, чем 200000 рублей, поэтому, возможно, данная госпошлина – это сумма госпошлин по нескольким требованиям (т.к. больше максимальной суммы в 200000 рублей). \nТакую ситуацию наш алгоритм не обрабатывает."
                    }
