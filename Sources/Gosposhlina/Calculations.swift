        ...
        case .ru09092024:
            ...
            case .commonUrisdiction:
                ...
                case .one:
                    ...
                    // Если приказ
                    if isPrikaz {
                        // Деление суммы на 2 для судебного приказа
                        // выполняется на уровне вызывающего кода (массовый расчёт),
                        // здесь меняем только поясняющий текст.
                        if amount <= 500000 {
            ...
            case .arbitrazh:
                ...
                case .one:
                    ...
                    // Если приказ
                    if isPrikaz {
                        // Деление суммы на 2 и ограничение "не менее 8000 руб."
                        // реализуются на уровне вызывающего кода (массовый расчёт),
                        // здесь меняем только поясняющий текст.
                        if amount < 750000 {
