        ...
        case .ru01012005_08092024:
            ...
            case .arbitrazh:
                ...
                if amount == 0 {
                    ...
                    if amount > 200000 {
                        textLabel = "Введенная госпошлина больше, чем 200000 рублей, поэтому, возможно, данная госпошлина – это сумма госпошлин по нескольким требованиям (т.к. больше максимальной суммы в 200000 рублей). Такую ситуацию данный алгоритм не обрабатывает."
                    }
